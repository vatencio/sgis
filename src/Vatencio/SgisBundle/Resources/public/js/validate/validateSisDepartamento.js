$(document).ready(function(){
    $("[name='sis_departamento']").validate({
        messages: {
            rht_rhtonlinebundle_sisdepartamentotype_nombre: {
    ...
    $("form[name='sis_departamento'] select").change(function(){
        $("form[name='sis_departamento'] div").find("label.error").each(function(index,element){
    ...
    $("form[name='sis_departamento'] input,select,textarea").blur(function(){
        ...
        if($("form[name='sis_departamento'] .error").text() && !visible){
        ...
        if((boton_crear.hasClass('emergente') && $("form[name='sis_departamento']").parent().attr("id") === "show_form_emergente")
            || (!boton_crear.hasClass('emergente') && $("form[name='sis_departamento']").parent().attr("id") === "show_form")){
            hacer_focus = true;
        }else{
            hacer_focus = false;
        }
    ...
    if($("form[name='sis_departamento']").parent().attr("id") !== "show_form_emergente"){
        boton_nuevo();
    }
});