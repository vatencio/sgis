$(document).ready(function(){
    $("[name='pru_variable_nivel']").validate({
        messages: {
    ...
    $("form[name='pru_variable_nivel'] select").change(function(){
        $("form[name='pru_variable_nivel'] div").find("label.error").each(function(index,element){
    ...
    $("form[name='pru_variable_nivel'] input,select,textarea").blur(function(){
        ...
        if($("form[name='pru_variable_nivel'] .error").text() && !visible){
        ...
        if((boton_crear.hasClass('emergente') && $("form[name='pru_variable_nivel']").parent().attr("id") === "show_form_emergente")
            || (!boton_crear.hasClass('emergente') && $("form[name='pru_variable_nivel']").parent().attr("id") === "show_form")){
            hacer_focus = true;
        }else{
            hacer_focus = false;
        }
        ...
        boton_crear.focus(function(){
            if(hacer_focus){
                ...
                $("[name='pru_variable_nivel']").submit();
                if($("form[name='pru_variable_nivel'] .error").text() && !visible){
                    boton_crear.attr('disabled',true);
                }else{
    ...
    if($("form[name='pru_variable_nivel']").parent().attr("id") !== "show_form_emergente"){
        boton_nuevo();
    }
});