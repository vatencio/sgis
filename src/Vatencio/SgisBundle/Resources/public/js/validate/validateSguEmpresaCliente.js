$(document).ready(function(){
    ...
    $("[name='sgu_empresa_cliente']").validate({
    /*messages: {
    ...
    $("form[name='sgu_empresa_cliente'] select").change(function(){
        $("form[name='sgu_empresa_cliente'] div").find("label.error").each(function(index,element){
    ...
    $("form[name='sgu_empresa_cliente'] input,select,textarea").blur(function(){
       // Si existe un boton con la clase emergente, nos indica que hay abierto un "nuevo emergente"
        ...
        if($("form[name='sgu_empresa_cliente'] .error").text() && !visible){
        ...
        if((boton_crear.hasClass('emergente') && $("form[name='sgu_empresa_cliente']").parent().attr("id") === "show_form_emergente")
            || (!boton_crear.hasClass('emergente') && $("form[name='sgu_empresa_cliente']").parent().attr("id") === "show_form")){
            hacer_focus = true;
        }else{
            hacer_focus = false;
        }
        ...
        boton_crear.focus(function(){
            if(hacer_focus){
                ...
                $("[name='sgu_empresa_cliente']").submit();
                if($("form[name='sgu_empresa_cliente'] .error").text() && !visible){
                    boton_crear.attr('disabled',true);
                }else{
    ...
    if($("form[name='sgu_empresa_cliente']").parent().attr("id") !== "show_form_emergente"){
        boton_nuevo();
    }
