$(document).ready(function(){
    ...
    $("form[name='fac_factura'] select").change(function(){
        $("form[name='fac_factura'] div").find("label.error").each(function(index,element){
    ...
    $("form[name='fac_factura'] input,select,textarea").blur(function(){
        ...
        if($("form[name='fac_factura'] .error").text() && !visible){
        ...
        if((boton_crear.hasClass('emergente') && $("form[name='fac_factura']").parent().attr("id") === "show_form_emergente")
            || (!boton_crear.hasClass('emergente') && $("form[name='fac_factura']").parent().attr("id") === "show_form")){
            hacer_focus = true;
        }else{
            hacer_focus = false;
        }
    ...
    if($("form[name='fac_factura']").parent().attr("id") !== "show_form_emergente"){
        boton_nuevo();
    }
});