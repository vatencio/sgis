$(document).ready(function(){
    $("[name='sis_estado_prueba_asignada']").validate({
        messages: {
            rht_rhtonlinebundle_sisestadopruebaasignadatype_nombre: {
    ...
    $("form[name='sis_estado_prueba_asignada'] select").change(function(){
        $("form[name='sis_estado_prueba_asignada'] div").find("label.error").each(function(index,element){
    ...
    $("form[name='sis_estado_prueba_asignada'] input,select,textarea").blur(function(){
        ...
        if($("form[name='sis_estado_prueba_asignada'] .error").text() && !visible){
        ...
        if((boton_crear.hasClass('emergente') && $("form[name='sis_estado_prueba_asignada']").parent().attr("id") === "show_form_emergente")
            || (!boton_crear.hasClass('emergente') && $("form[name='sis_estado_prueba_asignada']").parent().attr("id") === "show_form")){
            hacer_focus = true;
        }else{
            hacer_focus = false;
        }
        ...
        boton_crear.focus(function(){
            if(hacer_focus){
                ...
                $("[name='sis_estado_prueba_asignada']").submit();
                if($("form[name='sis_estado_prueba_asignada'] .error").text() && !visible){
                    boton_crear.attr('disabled',true);
                }else{
    ...
    if($("form[name='sis_estado_prueba_asignada']").parent().attr("id") !== "show_form_emergente"){
        boton_nuevo();
    }
});