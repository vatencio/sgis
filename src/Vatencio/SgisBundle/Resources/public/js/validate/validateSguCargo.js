$(document).ready(function(){
    $("[name='sgu_cargo']").validate({
        messages: {
            rht_rhtonlinebundle_prutipopreguntatype_nombre: {
                required: "Por favor, ingrese el nombre"
            },
            rht_rhtonlinebundle_sgucargotype_funciones: {
                required: "Por favor, ingrese las funciones"
            },
            rht_rhtonlinebundle_sgucargotype_objetivos: {
                required: "Por favor, ingrese los objetivos"
            }
        },
    ...
    $("form[name='sgu_cargo'] select").change(function(){
        $("form[name='sgu_cargo'] div").find("label.error").each(function(index,element){
    ...
    $("form[name='sgu_cargo'] input,select,textarea").blur(function(){
        ...
        if($("form[name='sgu_cargo'] .error").text() && !visible){
        ...
        if((boton_crear.hasClass('emergente') && $("form[name='sgu_cargo']").parent().attr("id") === "show_form_emergente")
            || (!boton_crear.hasClass('emergente') && $("form[name='sgu_cargo']").parent().attr("id") === "show_form")){
            hacer_focus = true;
        }else{
            hacer_focus = false;
        }
    ...
    if($("form[name='sgu_cargo']").parent().attr("id") !== "show_form_emergente"){
        boton_nuevo();
    }
});