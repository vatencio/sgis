$(document).ready(function(){
    ...
    $("form[name='sis_pais'] select").change(function(){
        $("form[name='sis_pais'] div").find("label.error").each(function(index,element){
    ...
    $("form[name='sis_pais'] input,select,textarea").blur(function(){
        ...
        if($("form[name='sis_pais'] .error").text() && !visible){
        ...
        if((boton_crear.hasClass('emergente') && $("form[name='sis_pais']").parent().attr("id") === "show_form_emergente")
            || (!boton_crear.hasClass('emergente') && $("form[name='sis_pais']").parent().attr("id") === "show_form")){
            hacer_focus = true;
        }else{
            hacer_focus = false;
        }
    ...
    if($("form[name='sis_pais']").parent().attr("id") !== "show_form_emergente"){
        boton_nuevo();
    }
});