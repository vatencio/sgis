$(document).ready(function(){
    $("[name='sis_ciudad']").validate({
        messages: {
            rht_rhtonlinebundle_sisciudadtype_nombre: {
    ...
    $("form[name='sis_ciudad'] select").change(function(){
        $("form[name='sis_ciudad'] div").find("label.error").each(function(index,element){
    ...
    $("form[name='sis_ciudad'] input,select,textarea").blur(function(){
        ...
        if($("form[name='sis_ciudad'] .error").text() && !visible){
        ...
        if((boton_crear.hasClass('emergente') && $("form[name='sis_ciudad']").parent().attr("id") === "show_form_emergente")
            || (!boton_crear.hasClass('emergente') && $("form[name='sis_ciudad']").parent().attr("id") === "show_form")){
            hacer_focus = true;
        }else{
            hacer_focus = false;
        }
    ...
    if($("form[name='sis_ciudad']").parent().attr("id") !== "show_form_emergente"){
        boton_nuevo();
    }
});