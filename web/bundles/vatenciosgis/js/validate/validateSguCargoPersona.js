$(document).ready(function(){
    ...
    $("[name='sgu_cargo_persona']").validate({
    /*messages: {
    ...
    $("form[name='sgu_cargo_persona'] select").change(function(){
        $("form[name='sgu_cargo_persona'] div").find("label.error").each(function(index,element){
    ...
    $("form[name='sgu_cargo_persona'] input,select,textarea").blur(function(){
        ...
        if($("form[name='sgu_cargo_persona'] .error").text() && !visible){
        ...
        if((boton_crear.hasClass('emergente') && $("form[name='sgu_cargo_persona']").parent().attr("id") === "show_form_emergente")
            || (!boton_crear.hasClass('emergente') && $("form[name='sgu_cargo_persona']").parent().attr("id") === "show_form")){
            hacer_focus = true;
        }else{
            hacer_focus = false;
        }
    ...
    if($("form[name='sgu_cargo_persona']").parent().attr("id") !== "show_form_emergente"){
        boton_nuevo();
    }
