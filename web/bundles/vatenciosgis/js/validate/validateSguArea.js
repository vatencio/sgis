$(document).ready(function(){
    ...
    $("form[name='sgu_area'] select").change(function(){
        $("form[name='sgu_area'] div").find("label.error").each(function(index,element){
    ...
    $("form[name='sgu_area'] input,select,textarea").blur(function(){
        ...
        if($("form[name='sgu_area'] .error").text() && !visible){
        ...
        if((boton_crear.hasClass('emergente') && $("form[name='sgu_area']").parent().attr("id") === "show_form_emergente")
            || (!boton_crear.hasClass('emergente') && $("form[name='sgu_area']").parent().attr("id") === "show_form")){
            hacer_focus = true;
        }else{
            hacer_focus = false;
        }
    ...
    if($("form[name='sgu_area']").parent().attr("id") !== "show_form_emergente"){
        boton_nuevo();
    }
