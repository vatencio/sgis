$(document).ready(function(){
    ...
    $("[name='sgu_empresa_persona']").validate({
    /*messages: {
    ...
    $("form[name='sgu_empresa_persona'] select").change(function(){
        $("form[name='sgu_empresa_persona'] div").find("label.error").each(function(index,element){
    ...
    $("form[name='sgu_empresa_persona'] input,select,textarea").blur(function(){
        ...
        if($("form[name='sgu_empresa_persona'] .error").text() && !visible){
        ...
        if((boton_crear.hasClass('emergente') && $("form[name='sgu_empresa_persona']").parent().attr("id") === "show_form_emergente")
            || (!boton_crear.hasClass('emergente') && $("form[name='sgu_empresa_persona']").parent().attr("id") === "show_form")){
            hacer_focus = true;
        }else{
            hacer_focus = false;
        }
        ...
        boton_crear.focus(function(){
            if(hacer_focus){
                ...
                $("[name='sgu_empresa_persona']").submit();
                if($("form[name='sgu_empresa_persona'] .error").text() && !visible){
                    boton_crear.attr('disabled',true);
                }else{
    ...
    if($("form[name='sgu_empresa_persona']").parent().attr("id") !== "show_form_emergente"){
        boton_nuevo();
    }
