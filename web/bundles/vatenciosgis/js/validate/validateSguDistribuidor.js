$(document).ready(function(){
    ...
    $("[name='sgu_distribuidor']").validate({
    /*messages: {
    ...
    $("form[name='sgu_distribuidor'] select").change(function(){
        $("form[name='sgu_distribuidor'] div").find("label.error").each(function(index,element){
    ...
    $("form[name='sgu_distribuidor'] input,select,textarea").blur(function(){
        ...
        if($("form[name='sgu_distribuidor'] .error").text() && !visible){
        ...
        if((boton_crear.hasClass('emergente') && $("form[name='sgu_distribuidor']").parent().attr("id") === "show_form_emergente")
            || (!boton_crear.hasClass('emergente') && $("form[name='sgu_distribuidor']").parent().attr("id") === "show_form")){
            hacer_focus = true;
        }else{
            hacer_focus = false;
        }
    ...
    if($("form[name='sgu_distribuidor']").parent().attr("id") !== "show_form_emergente"){
        boton_nuevo();
    }
