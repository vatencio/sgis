$(document).ready(function(){
    ...
    $("form[name='pru_pregunta'] select").change(function(){
        $("form[name='pru_pregunta'] div").find("label.error").each(function(index,element){
    ...
    $("form[name='pru_pregunta'] input,select,textarea").blur(function(){
        ...
        if($("form[name='pru_pregunta'] .error").text() && !visible){
        ...
        if((boton_crear.hasClass('emergente') && $("form[name='pru_pregunta']").parent().attr("id") === "show_form_emergente")
            || (!boton_crear.hasClass('emergente') && $("form[name='pru_pregunta']").parent().attr("id") === "show_form")){
            hacer_focus = true;
        }else{
            hacer_focus = false;
        }
    ...
    if($("form[name='pru_pregunta']").parent().attr("id") !== "show_form_emergente"){
        boton_nuevo();
    }
