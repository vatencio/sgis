$(document).ready(function(){
    ...
    $("[name='sgu_usuario_prueba']").validate({
    /*messages: {
        rht_rhtonlinebundle_prutipopreguntatype_nombre: {
    ...
    $("form[name='sgu_usuario_prueba'] select").change(function(){
        $("form[name='sgu_usuario_prueba'] div").find("label.error").each(function(index,element){
    ...
    $("form[name='sgu_usuario_prueba'] input,select,textarea").blur(function(){
        ...
        if($("form[name='sgu_usuario_prueba'] .error").text() && !visible){
        ...
        if((boton_crear.hasClass('emergente') && $("form[name='sgu_usuario_prueba']").parent().attr("id") === "show_form_emergente")
            || (!boton_crear.hasClass('emergente') && $("form[name='sgu_usuario_prueba']").parent().attr("id") === "show_form")){
            hacer_focus = true;
        }else{
            hacer_focus = false;
        }
        ...
        boton_crear.focus(function(){
            if(hacer_focus){
                ...
                $("[name='sgu_usuario_prueba']").submit();
                if($("form[name='sgu_usuario_prueba'] .error").text() && !visible){
                    boton_crear.attr('disabled',true);
                }else{
    ...
    if($("form[name='sgu_usuario_prueba']").parent().attr("id") !== "show_form_emergente"){
        boton_nuevo();
    }
});