$(document).ready(function(){
    ...
    $("form[name='pru_baremo'] select").change(function(){
        $("form[name='pru_baremo'] div").find("label.error").each(function(index,element){
    ...
    $("form[name='pru_baremo'] input,select,textarea").blur(function(){
        ...
        if($("form[name='pru_baremo'] .error").text() && !visible){
        ...
        if((boton_crear.hasClass('emergente') && $("form[name='pru_baremo']").parent().attr("id") === "show_form_emergente")
            || (!boton_crear.hasClass('emergente') && $("form[name='pru_baremo']").parent().attr("id") === "show_form")){
            hacer_focus = true;
        }else{
            hacer_focus = false;
        }
    ...
    if($("form[name='pru_baremo']").parent().attr("id") !== "show_form_emergente"){
        boton_nuevo();
    }
});